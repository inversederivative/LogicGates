...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(TwoInputJSON_ToNode_Test, "LogicGates.TwoInputJSON_ToNode_Tests", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)
